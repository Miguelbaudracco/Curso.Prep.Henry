...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  //const nomest = ['Martin', 'Antonio', 'Sara', 'Samuel'];
...
function dePalabrasAFrase(palabras) {
  ...
  for (let i=0; i<palabras.length; i++)
  {
    ...
    if (i==(palabras.length-1)) {return cadena};
    cadena=cadena+' ';  
  }
}
...
function breakStatement(numero) {
  ...
  for (i=0; i<10; i++)
  {
     ...
     nuevoarray.push(sumanumero);
      if (i==sumanumero) break;
  }
...
function continueStatement(numero) {
  ...
  {
      if (i==5) continue;
            else {sumanumero=sumanumero+2;nuevoarray.push(sumanumero)};
  }
  return nuevoarray;
}
